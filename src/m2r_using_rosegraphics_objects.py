...
#            Draws any points attached to the window when called.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            Always, because it allows the user to observe everything as long as necessary.
#
